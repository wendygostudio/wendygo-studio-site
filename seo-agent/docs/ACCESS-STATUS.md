...
Última comprobación: 2026-08-14.

| Fuente | Estado | Evidencia / siguiente acción |
|---|---|---|
| Search Console | **Operativa** | Refresco del 2026-08-14: 50 páginas y 50 consultas finales para 2026-07-15 → 2026-08-11. |
...
| Plausible | **No configurado** | `PLAUSIBLE_API_KEY`, `PLAUSIBLE_SITE_ID` y `PLAUSIBLE_URL` están vacíos o ausentes en `agent.env`; no hubo lectura el 2026-08-14. |
