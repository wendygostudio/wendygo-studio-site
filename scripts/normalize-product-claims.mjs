...
const jobs = [
  ...
  },
  {
    ...
    replacements: [
      ...
      [/<p>Comparison of tools used to sanitize network configs before sharing: bash one-liners, VSCode manual regex, CyberChef pipelines, and ScrubForge\. Honest pros and cons for each approach\.<\/p>/g, '<p>Comparison of tools used to sanitize network configs before sharing: bash one-liners, VSCode manual regex, CyberChef pipelines, and ScrubForge. Honest pros and cons for each approach. CyberChef is entirely client-side: its input and recipes are not sent to its web server.</p>']
    ]
  },
  {
