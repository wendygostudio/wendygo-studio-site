---
schemaVersion: 1
title: "Pomodoro Focus Shield pour Chrome\_: bloquez les distractions sans interrompre votre flux de travail"
description: >-
  Utilisez un Pomodoro Focus Shield dans Chrome pour réduire les sites
  distrayants tout en conservant les onglets et les outils dont votre session de
...
product: slimeforge
contentType: how-to
primaryKeyword: Pomodoro bouclier de mise au point chromé
relatedPages: >-
...
La version utile est prévisible. Vous choisissez une session, définissez les sites qui ont tendance à vous éloigner et recevez un avertissement ou un blocage pendant que le timer est actif. À la fin de la session, la restriction devrait cesser sans vous obliger à reconstruire la configuration de votre navigateur.
...
## Utiliser SlimeForge comme minuterie et bouclier
...
### Par quelle durée dois-je commencer ?
Choisissez le bloc le plus court qui vous permet encore de faire des progrès visibles, généralement 15 ou 25 minutes lors de la construction de l'habitude.
