...
ADR bodies are certified independent mediators that handle consumer-seller disputes. The EU mandates that every EU member state has them for key sectors (retail, travel, finance, telecoms, energy).

- **Cost:** Free or nominal (typically under €30 for consumers)
- **Timeline:** Most cases resolved within 90 days of acceptance
- **How:** Check if the seller is registered with a certified ADR body on the European Commission's ADR entity list
- **Binding?** Often binding on the trader, not on you — meaning you can still go to court if you're unsatisfied with the outcome

ADR is the go-to first alternative when negotiating directly with the seller has failed.

## Alternative 2: Your National Consumer Authority

Every EU member state has a government body responsible for enforcing consumer rights. They won't fight your individual battle, but filing a complaint creates a paper trail — and sellers know that repeat complaints to authorities can trigger formal sanctions.
...
## Alternative 4: Small Claims Court

If every other channel has failed, small claims courts in EU countries allow you to file for modest amounts (typically up to €5,000 under the European Small Claims Procedure) without a lawyer. Filing fees are low — often €25–75 — and are reimbursed if you win. The process is mostly written, so you don't need to appear in court in person.

This is the nuclear option, but it's accessible, and sellers generally settle before it reaches a judge because the legal and reputational costs exceed the claim amount.

## Alternative 5: Credit Card Chargeback

If you paid by credit or debit card, your bank's chargeback process may be the fastest path to a refund — sometimes resolved in days rather than months. This works best for:

- Non-delivery of goods
- Goods significantly not as described
- Seller has gone unresponsive

Initiate through your bank directly. Be aware that chargebacks have time limits (usually 120 days from the transaction date) and are not guaranteed.

## Know Your Rights Before You Start

Half the battle in any consumer dispute is knowing exactly what you're entitled to. EU consumer law is comprehensive but fragmented — the 2-year legal guarantee, the 14-day right of return, your GDPR rights over personal data, the right to repair — and sellers often count on you not knowing which rule applies.

ClaimForge is a free Chrome extension that surfaces the specific EU consumer right relevant to your situation, explains what the seller is legally required to do, and walks you through the appropriate channel for your case. It doesn't file anything for you — but it means you go into any dispute knowing the law on your side.
...
- The dispute is over €2,000+ and the seller is stonewalling after every channel has been exhausted
- There are signs of deliberate fraud, not just negligence
- You need to enforce a binding ADR or court decision the seller is ignoring
- A collective action is possible (multiple consumers with the same complaint)

For everything else, the alternatives above have a strong track record.
